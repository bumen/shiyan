...
public class FormatterTest {
    ...
    private static void formatTimeAndDate() {
        ...
        //%tm/%td/%ty的缩写，输出形如
        System.out.println(String.format("'D':将时间格式化为：10/19/16。输出：%10tD", calendar));
        //%tY-%tm-%td，输出形如：
        ...
        System.out.println(String.format(Locale.US, "'c':将时间格式化为\"Sun Jul 20 16:17:00 EDT 1969\"。输出：%tc", calendar));
    }
