...
import com.bmn.sdk.weixin.pay.WXPayConstants.SignType;
...
public class WXPay {
     ...
     * @throws Exception
     */
    public Map<String, String> fillOrderCallback(Map<String, String> reqData) throws Exception {
        reqData.put("appId", config.getAppID());
     ...
     * @throws Exception
     */
    public Map<String, String> processResponseXml(Map<String, String> respData) throws Exception {
        String RETURN_CODE = "return_code";
        String return_code;
        if (respData.containsKey(RETURN_CODE)) {
            return_code = respData.get(RETURN_CODE);
        } else {
            throw new Exception(String.format("No `return_code` in XML: %s", respData));
        }
        ...
        if (return_code.equals(WXPayConstants.FAIL)) {
            ...
            if (this.isResponseSignatureValid(respData)) {
                ...
                throw new Exception(String.format("Invalid sign value in XML: %s", respData));
            }
        } else {
            throw new Exception(String.format("return_code value %s is invalid in XML: %s",
                    return_code, respData));
        }
    }
